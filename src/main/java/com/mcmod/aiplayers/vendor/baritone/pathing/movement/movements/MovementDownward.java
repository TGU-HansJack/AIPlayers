...
// Upstream reference: baritone-1.21.11/src/main/java/baritone/pathing/movement/movements/MovementDownward.java
public class MovementDownward extends Movement {
    public MovementDownward(BlockPos src, BlockPos dest, double cost) {
    ...
    public MovementStatus update(BaritoneEntityContextAdapter context, BaritoneMovementExecutorAdapter executor) {
        return this.moveTowards(executor, this.dest, 0.9D, false);
    }
}
